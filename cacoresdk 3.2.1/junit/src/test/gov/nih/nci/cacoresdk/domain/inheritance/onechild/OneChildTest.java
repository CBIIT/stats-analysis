...
public class OneChildTest extends SDKTestBase
{
	...
	public void testEntireObjectCQL1() throws ApplicationException
	{
		...
		Collection results = getApplicationService().query(cqlQuery,"gov.nih.nci.cacoresdk.domain.inheritance.onechild.Human");
	...
	public void testEntireObjectCQL2() throws ApplicationException
	{
		...
		Collection results = getApplicationService().query(cqlQuery,"gov.nih.nci.cacoresdk.domain.inheritance.onechild.Mammal");
