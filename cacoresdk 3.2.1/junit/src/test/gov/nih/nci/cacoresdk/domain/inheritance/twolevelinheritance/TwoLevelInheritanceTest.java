...
public class TwoLevelInheritanceTest extends SDKTestBase
{
	...
	public void testEntireObjectCQL1() throws ApplicationException
	{
		...
		Collection results = getApplicationService().query(cqlQuery,"gov.nih.nci.cacoresdk.domain.inheritance.twolevelinheritance.Display");
	...
	public void testEntireObjectCQL2() throws ApplicationException
	{
		...
		Collection results = getApplicationService().query(cqlQuery,"gov.nih.nci.cacoresdk.domain.inheritance.twolevelinheritance.CRTMonitor");
	...
	public void testEntireObjectCQL3() throws ApplicationException
	{
		...
		Collection results = getApplicationService().query(cqlQuery,"gov.nih.nci.cacoresdk.domain.inheritance.twolevelinheritance.Monitor");
	...
	public void testEntireObjectCQL4() throws ApplicationException
	{
		...
		Collection results = getApplicationService().query(cqlQuery,"gov.nih.nci.cacoresdk.domain.inheritance.twolevelinheritance.LCDMonitor");
