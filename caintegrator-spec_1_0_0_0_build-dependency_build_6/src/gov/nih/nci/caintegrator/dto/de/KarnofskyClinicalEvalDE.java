...
public class KarnofskyClinicalEvalDE extends DomainElement implements Serializable,
	...
	/**
	 * Sets the value for this <code>KarnofskyClinicalEvalDE</code> object
	 * 
	 * @param object
	 *            the value
	 */
	...
	/**
	 * Returns the karnofskyName for this KarnofskyClinicalEvalDE obect.
	 * 
	 * @return the karnofskyName for this <code>KarnofskyClinicalEvalDE</code> object
	 */
	...
	/**
	 * Sets the karnofskyName for this <code>KarnofskyClinicalEvalDE</code> object
	 * 
	 * @param karnofskyName
	 *            the karnofskyName
	 */
	public void setValueObject(String karnofskyName) {
		if (karnofskyName != null) {
			value = karnofskyName;
		}
	}
	/**
	 ...
	 */
	public Object clone() {
		KarnofskyClinicalEvalDE myClone = (KarnofskyClinicalEvalDE) super.clone();
		return myClone;
	}
}
