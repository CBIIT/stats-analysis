...
public abstract class AnalysisTask implements Runnable {
	...
	/**
	 * Release resources and clean up R environment. Called after the 
	...
	public String toString() { return "AnalysisTask thread=" + getExecutingThreadName() + " request=" + request.toString(); }
