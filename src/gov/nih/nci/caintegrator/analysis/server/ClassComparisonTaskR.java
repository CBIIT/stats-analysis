...
public class ClassComparisonTaskR extends AnalysisTaskR {
	...
	public void run() {
	  ...
	  System.out.println("Processing class comparison request=" + ccRequest);
		...
		//get the labels
		Vector reporterIds =   doREval("ccLabels <- dimnames(ccResult)[[1]]").asVector();
	...
	public AnalysisResult getResult() { return ccResult; }
	
	public ClassComparisonResult getClassComparisonResult() { return ccResult; }
