...
*/
   ...
   */
    ...
    private Set <gov.nih.nci.caintegrator.domain.annotation.snp.SNPAnnotation> snpAnnotationCollection = new HashSet<gov.nih.nci.caintegrator.domain.annotation.snp.SNPAnnotation>();
      /**
   * Places in the genomic sequence where one fraction of the human population has one nucleotide or allele, 
   * while another fraction has another. 
   * 
   */
    ...
    public Set <gov.nih.nci.caintegrator.domain.annotation.snp.SNPAnnotation> getSnpAnnotationCollection(){
        return snpAnnotationCollection;
    }
    public void setSnpAnnotationCollection(Set<gov.nih.nci.caintegrator.domain.annotation.snp.SNPAnnotation> snpAnnotationCollection){
