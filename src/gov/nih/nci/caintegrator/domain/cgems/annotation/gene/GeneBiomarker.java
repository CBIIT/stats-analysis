...
package gov.nih.nci.caintegrator.domain.cgems.annotation.gene;
...
*/
   ...
   */
    ...
    private Set <gov.nih.nci.caintegrator.domain.cgems.annotation.snp.SNPAnnotation> snpAnnotationCollection = new HashSet<gov.nih.nci.caintegrator.domain.cgems.annotation.snp.SNPAnnotation>();
      /**
   * Places in the genomic sequence where one fraction of the human population has one nucleotide or allele, 
   * while another fraction has another. 
   * 
   */
    ...
    public Set <gov.nih.nci.caintegrator.domain.cgems.annotation.snp.SNPAnnotation> getSnpAnnotationCollection(){
        return snpAnnotationCollection;
    }
    public void setSnpAnnotationCollection(Set<gov.nih.nci.caintegrator.domain.cgems.annotation.snp.SNPAnnotation> snpAnnotationCollection){
   ...
   */
   ...
   // private Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.GOTerm> goTermCollection = new HashSet<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GOTerm>();
      /**
   * The Gene Ontology (GO) project is a collaborative effort to address the need for consistent descriptions 
   * of gene products in different databases. The goal of the Gene Ontology project is to produce a controlled 
   * vocabulary that can be applied to all organisms even as knowledge of gene and protein roles in cells 
   ...
   */
   ...
   /* public Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GOTerm> getGoTermCollection(){
    ...
    public void setGoTermCollection(Set<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GOTerm> goTermCollection){
...
//    private Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GeneExprReporter> geneExprReporterCollection = new HashSet<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GeneExprReporter>();
      /**
   * A Design Element that represents some biological material (clone, oligo, etc.) on an array which 
   * will report on some biosequence or biosequences; eg: Affymetrix probeset or cDNA clone (Note: may 
   * not be equivalent to a MAGE-OM Reporter in all cases.) 
  ...
  /*  public Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GeneExprReporter> getGeneExprReporterCollection(){
    ...
    public void setGeneExprReporterCollection(Set<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GeneExprReporter> geneExprReporterCollection){
...
//    private Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GenBankAccession> genBankAccessionCollection = new HashSet<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GenBankAccession>();
      /**
   * The accession number is the unique identifier assigned to the entire sequence record when the record 
   * is submitted to GenBank. 
   * 
...
/*
    public Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GenBankAccession> getGenBankAccessionCollection(){
    ...
    public void setGenBankAccessionCollection(Set<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GenBankAccession> genBankAccessionCollection){
...
//    private Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.Pathway> pathwayCollection = new HashSet<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.Pathway>();
      /**
   * An elaboration of the sequence of chemical reactions leading from one compound to another taking 
   * place in living tissue._A statement or an account describing something._Value Domain for java 
   * language String datatype. 
...
/*
    ...
    public Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.Pathway> getPathwayCollection(){
    ...
    public void setPathwayCollection(Set<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.Pathway> pathwayCollection){
...
//    private Set <gov.nih.nci.caintegrator.domain.cgems.annotation.protein.bean.ProteinBiomarker> proteinBiomarkerCollection = new HashSet<gov.nih.nci.caintegrator.domain.cgems.annotation.protein.bean.ProteinBiomarker>();
      /**
   * A ProteinBiomarker is a protein or antibody based biological parameter that is indicative of a physiological 
   * or pathological state. For example, HER2 is a biomarker used to identify risk of breast cancer. 
   * 
 ...
 /*   public Set <gov.nih.nci.caintegrator.domain.cgems.annotation.protein.bean.ProteinBiomarker> getProteinBiomarkerCollection(){
    ...
    public void setProteinBiomarkerCollection(Set<gov.nih.nci.caintegrator.domain.cgems.annotation.protein.bean.ProteinBiomarker> proteinBiomarkerCollection){
...
//    private Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GeneAlias> geneAliasCollection = new HashSet<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GeneAlias>();
      /**
   * Alternative gene symbol to the official HUGO gene symbol
   */

 /*   public Set <gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GeneAlias> getGeneAliasCollection(){
    ...
    public void setGeneAliasCollection(Set<gov.nih.nci.caintegrator.domain.cgems.annotation.gene.bean.GeneAlias> geneAliasCollection){
...
*/
    ...
    public String toString() {
        return "GeneBiomarker{" +
                "startPhyscialLocation=" + startPhyscialLocation + "\n" +
                ", endPhysicalLocation=" + endPhysicalLocation + "\n" +
                ", id='" + id  + "\n" +
