...
public class FrequencyPopulation
...
implements java.io.Serializable {
	...
	/**
	 * The source attribution for information and biological samples for a study
	 * population
	 * 
	 */
	...
	public boolean equals(Object obj) {
		boolean eq = false;
		if (obj instanceof FrequencyPopulation) {
			FrequencyPopulation c = (FrequencyPopulation) obj;
			Long thisId = getId();
	...
	/**
	 * A class describing counts and characteristics of alleles and genotypes
	 * for SNP polymorphisms observed in a CGEMS population.
	 * 
	 */
	...
	public void setSnpFrequencyCollection(
			Set<gov.nih.nci.caintegrator.domain.finding.variation.snpFrequency.bean.SNPFrequencyFinding> snpFrequencyCollection) {
	...
	public void setStudyParticipantCollection(
			Set<gov.nih.nci.caintegrator.domain.study.bean.StudyParticipant> studyParticipantCollection) {
		this.studyParticipantCollection = studyParticipantCollection;
	}

	/**
	 * A type of research activity that tests how well new medical treatments or
	 * other interventions work in subjects. Such plans test new methods of
	 * screening, prevention, diagnosis or treatment of a disease. The specific
	 * plans are fully defined in the protocol and may be carried out in a
	...
	public void setStudyCollection(
			Set<gov.nih.nci.caintegrator.domain.study.bean.Study> studyCollection) {
		this.studyCollection = studyCollection;
	}

	public String toString() {
		return "Population{" + "description='" + description + '\'' + ", id="
				+ id + ", memberCount=" + memberCount + ", name='" + name
				+ '\'' + ", source='" + source + '\'' + '}';
	}
}