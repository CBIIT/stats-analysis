...
public class AnnotationCriteria {
    ...
    private gov.nih.nci.cgems.dto.CytobandCriteria cytobandCriteria;
    private String[] geneOntology;
    private String[] genePathways;
    private Collection<String> geneSymbols;
    private gov.nih.nci.cgems.dto.OperatorType operatorType;
    private gov.nih.nci.cgems.dto.PanelCriteria panelCriteria;
