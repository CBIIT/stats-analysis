...
# Call function
# filtered.result <- mydiferentiallygenes(datmat,raw.result,2,0.001)

###############################################################################################################
# Identify differentially expressed genes based on absolute fold change>=2 and adjustP<=0.1

mydiferentiallygenes.adjustP <- function(datmat, adjust.result, cons1=2, cons2=0.1) {
...
# Call function
# filtered.result <- mydiferentiallygenes.adjustP(datmat,adjust.result,2,0.1)
